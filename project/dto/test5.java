...
public class test5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(service.path("rest").path("products/delete").accept(MediaType.APPLICATION_JSON, MediaType.TEXT_PLAIN).post(ClientResponse.class,jsonuser).getEntity(String.class));
